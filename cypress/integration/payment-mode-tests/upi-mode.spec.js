...
describe("UPI Payment Mode", () => {
    let testData;
    beforeEach(function () {
        cy.fixture('mode-of-payments-data/upi-mode').then(function (data) {
            testData=data;
            return testData;
        })
    })

    it('login,fill details for UPI mode payment & submit', () => {
        cy.visit("/");
        ...
        if(test_same_digit(testData.UTR_No))
        {
        ...
        if(UTR_digits_count(testData.UTR_No)==10)
        {
