...
describe("Cash Mode Action", () => {
    ...
    let testData;
    beforeEach(function () {
        cy.fixture('donation-list-action-data/cash-action-data').then(function (data) {
            testData = data;
            return testData;
        });
    })
    ...
    it('login,actions related to cash mode payment', () => {
        cy.visit("/");
        ...
        cy.get('.mat-tab-label').contains('Cash').click({force:true});
        cy.wait(2000);
...
describe("First test (Cash Mode Action related)", () => {

    let testData;
    beforeEach(function () {
        cy.fixture('donation-list-action-data/cash_actionData').then(function (data) {
            testData = data;
            return testData;
        });
    })
    ...
    it('login then click on total count ', () => {
        ...
        // click on cash button
        cy.get('.mat-tab-header-pagination-after > .mat-tab-header-pagination-chevron')
            .click();

        cy.get('#mat-tab-label-0-7 > .mat-tab-label-content > .ng-star-inserted > .tab-text')
            .click({force:true});
        ...
        {
            cy.log('Bounced is not applicable in cash');
