...
/*
describe("RTGS Action", () => {

    let testData;
    beforeEach(function () {
        cy.fixture('donation-list-action-data/RTGS_actionData').then(function (data) {
            testData = data;
            return testData;
        });
    })
    ...
    it('login then click on total count ', () => {
        ...
        // click on RTGS button
        cy.get('#mat-tab-label-0-2 > .mat-tab-label-content > .ng-star-inserted > .tab-text')
            .click();
