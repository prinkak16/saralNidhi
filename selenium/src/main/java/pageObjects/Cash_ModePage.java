...
public class Cash_ModePage {

	public WebDriver driver;

	public Cash_ModePage(WebDriver driver) {
		this.driver = driver;
	...
	By cash_mode_value = By.cssSelector("*[value='7']");
	By paymentMode = By.xpath("//span[contains(text(), 'Cash')]");
	...
	public WebElement getCashModeValue() {
		return driver.findElement(cash_mode_value);
	}

	public By getCashPaymentMode() {
		return paymentMode;
	}
