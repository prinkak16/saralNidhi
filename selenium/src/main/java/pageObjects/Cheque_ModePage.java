...
public class Cheque_ModePage {

	public WebDriver driver;

	public Cheque_ModePage(WebDriver driver) {
		this.driver = driver;
	...
	By cheque_mode_value = By.cssSelector("*[value='1']");
	By paymentMode = By.xpath("//span[contains(text(), 'Cheque')]");

	By chequeDate = By.cssSelector("[formcontrolname='date_of_cheque']");
	By chequeNumber = By.cssSelector("[formcontrolname='cheque_number']");

	By chequeFrontImg = By.xpath("(//input[@type='file'])[1]");
	By chequeBackImg = By.xpath("(//input[@type='file'])[2]");
	By wrongPanImg = By.xpath("(//input[@type='file'])[3]");

	By accountNumber = By.cssSelector("[formcontrolname='account_number']");
	By invalid_cheque = By.cssSelector("[role='alert']");
	...
	public WebElement getChequeModeValue() {
		return driver.findElement(cheque_mode_value);
	}

	public By getChequePaymentMode() {
		return paymentMode;
	}

	public WebElement getChequeDate() {
		return driver.findElement(chequeDate);
	}

	public WebElement getChequeNumber() {
		return driver.findElement(chequeNumber);
	}

	public void uploadFrontImage() {
		WebElement upload_file1 = driver.findElement(By.xpath("(//input[@type='file'])[1]"));
		upload_file1.sendKeys(System.getProperty("user.dir") + "\\src\\main\\java\\resources\\upload_image1.jpg");
	}

	public void uploadBackImage() {
		WebElement upload_file2 = driver.findElement(By.xpath("(//input[@type='file'])[2]"));
		upload_file2.sendKeys(System.getProperty("user.dir") + "\\src\\main\\java\\resources\\upload_image2.jpg");
	}

	public void uploadWrongPanImage() {
		WebElement upload_file3 = driver.findElement(By.xpath("(//input[@type='file'])[3]"));
	...
	public WebElement getInvalidCheque() {
		return driver.findElement(with(invalid_cheque).above(accountNumber));
	}
