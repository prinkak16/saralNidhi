...
public class RTGS_ModePage {

	public WebDriver driver;

	public RTGS_ModePage(WebDriver driver) {
		this.driver = driver;
	...
	By rtgs_mode_value = By.cssSelector("*[value='2']");
	By paymentMode = By.xpath("//span[contains(text(), 'RTGS')]");
	...
	public WebElement getRTGSModeValue() {
		return driver.findElement(rtgs_mode_value);
	}

	public By getRTGSPaymentMode() {
		return paymentMode;
	}
