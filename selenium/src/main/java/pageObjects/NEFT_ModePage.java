...
public class NEFT_ModePage {

	public WebDriver driver;

	public NEFT_ModePage(WebDriver driver) {
		this.driver = driver;
	...
	By neft_mode_value = By.cssSelector("*[value='3']");
	By paymentMode = By.xpath("//span[contains(text(), 'NEFT')]");
	...
	public WebElement getNEFTModeValue() {
		return driver.findElement(neft_mode_value);
	}

	public By getNEFTPaymentMode() {
		return paymentMode;
	}
