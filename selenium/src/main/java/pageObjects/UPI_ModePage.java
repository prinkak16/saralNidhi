...
public class UPI_ModePage {

	public WebDriver driver;

	public UPI_ModePage(WebDriver driver) {
		this.driver = driver;
	...
	By upi_mode_value = By.cssSelector("*[value='6']");
	By paymentMode = By.xpath("//span[contains(text(), 'UPI')]");
	...
	public WebElement getUPIModeValue() {
		return driver.findElement(upi_mode_value);
	}

	public By getUPIPaymentMode() {
		return paymentMode;
	}
