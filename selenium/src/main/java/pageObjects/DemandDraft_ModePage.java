...
public class DemandDraft_ModePage {

	public WebDriver driver;

	public DemandDraft_ModePage(WebDriver driver) {
		this.driver = driver;
	...
	By demandDraft_mode_value = By.cssSelector("*[value='4']");
	By paymentMode = By.xpath("//span[contains(text(), 'Demand Draft')]");

	By draftDate = By.cssSelector("[formcontrolname='date_of_draft']");
	By draftNumber = By.cssSelector("[formcontrolname='draft_number']");
	By accountNumber = By.cssSelector("[formcontrolname='account_number']");
	By invalid_draft = By.cssSelector("[role='alert']");
	...
	public WebElement getDemandDraftModeValue() {
		return driver.findElement(demandDraft_mode_value);
	}

	public By getDemandDraftPaymentMode() {
		return paymentMode;
	}

	public WebElement getDraftDate() {
		return driver.findElement(draftDate);
	}

	public WebElement getDraftNumber() {
		return driver.findElement(draftNumber);
	}
	...
	public WebElement getInvalidDraft() {
		return driver.findElement(with(invalid_draft).above(accountNumber));
	}
