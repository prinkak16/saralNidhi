		...
		// click on Cash tab
			...
			JavascriptExecutor js = (JavascriptExecutor) driver;
	           ...
	           // clicking on 3 dots for action 
				...
				Boolean b = driver.findElement(By.cssSelector("*[value='7']")).isSelected();
				Boolean ca = driver.findElement(By.xpath("//input[@value='7']")).isSelected();
				
				System.out.println("Cash is selected :"+b);
				System.out.println("Cash is selected2 :"+ca);
                ...
                /*
        		boolean district_bool = wait
        				.until(ExpectedConditions.textToBePresentInElementValue(cashPage.getDistrict(), "Pune"));
        		String copied_district = null;
