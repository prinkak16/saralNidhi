		...
		// click on IMPS tab
			...
			JavascriptExecutor js = (JavascriptExecutor) driver;
	           ...
	           // clicking on 3 dots for action 
				...
				Boolean b = driver.findElement(By.cssSelector("*[value='5']")).isSelected();
				Boolean ca = driver.findElement(By.xpath("//input[@value='5']")).isSelected();
				
				System.out.println("imps is selected :"+b);
				System.out.println("imps is selected2 :"+ca);
