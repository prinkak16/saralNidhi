...
public class RTGSRelatedTest extends Base {
	public WebDriver driver;
	public NgWebDriver ngDriver;
	public static Logger log = LogManager.getLogger(RTGSRelatedTest.class);
	...
	@Test
	public void basePageNavigationRTGS(ITestContext context) throws IOException, InterruptedException {
		 ...
		 * loginButton.click();
		 */
		log.info("Login successfully in RTGS_ModeTest");
		...
		random_utr_no = "rt" + random_utr_no;
		...
		// wait.until(ExpectedConditions.textToBePresentInElement(rtgsPage.getWrongCollectorName(collector_name_input),"Please
		// enter a valid name"));
		...
		wait.until(ExpectedConditions.textToBePresentInElement(rtgsPage.getWrongCollectorPhone(collecter_phone),
		...
		for (String party_unit : party_unit_arr) {
			...
			if (party_unit == "CountryState") {
				...
				WebElement zila_unit = wait
						.until(ExpectedConditions.visibilityOfElementLocated(rtgsPage.selectGivenZila(zila_unit_name)));
				zila_unit.click();
	...
	@Test(dependsOnMethods = { "basePageNavigationRTGS" })
	public void viewActionForRTGS(ITestContext context) throws IOException, InterruptedException {
		JavascriptExecutor js = (JavascriptExecutor) driver;
		ArrayList<String> a = new ArrayList<String>();

		ActionReletedDataDriven dd = new ActionReletedDataDriven();
		ArrayList<String> excel_data = dd.getData("rtgsMode", a);
		...
		WebElement heading2 = wait.until(ExpectedConditions.visibilityOfElementLocated(rtgsPage.getFirstHeading()));
		...
		String locality = rtgsPage.getLocality().getAttribute("value");
		System.out.println("locality :" + locality);

		String pincode = rtgsPage.getPinCode().getAttribute("value");
		System.out.println("pincode :" + pincode);

		js.executeScript("window.scrollBy(0,1350)", "");

		// String district = rtgsPage.getDistrict().getAttribute("value");
		// System.out.println("district :"+district);

		/*
		 * boolean district_bool = wait
		 * .until(ExpectedConditions.textToBePresentInElementValue(rtgsPage.getDistrict(
		 * ), "Pune")); String copied_district = null;
		 * 
		 * if (district_bool) { copied_district =
		 * rtgsPage.getDistrict().getAttribute("value"); } else {
		 * log.error("district name didn't come till 50 sec"); }
		 * 
		 * System.out.println(copied_district);
		 * 
		 * String state = rtgsPage.getState().getText();
		...
		Thread.sleep(2000);
		String pan1 = rtgsPage.get1stPanInput().getAttribute("value");
		String pan2 = rtgsPage.get2ndPanInput().getAttribute("value");
		String pan3 = rtgsPage.get3rdPanInput().getAttribute("value");
		String pan4 = rtgsPage.get4thPanInput().getAttribute("value");

		String pan5 = rtgsPage.get5thPanInput().getAttribute("value");
		String pan6 = rtgsPage.get6thPanInput().getAttribute("value");
		String pan7 = rtgsPage.get7thPanInput().getAttribute("value");
		String pan8 = rtgsPage.get8thPanInput().getAttribute("value");

		String pan9 = rtgsPage.get9thPanInput().getAttribute("value");
		String pan10 = rtgsPage.getLastPanInput().getAttribute("value");
	...
	@Test(dependsOnMethods = { "viewActionForRTGS" })

	public void editActionForRTGS() throws InterruptedException, IOException {
		...
		js.executeScript("window.scrollBy(0,750)", "");
		// rtgsPage.uploadFrontImage();
		// rtgsPage.uploadBackImage();

		rtgsPage.getAccountNumber().clear();
		rtgsPage.getAccountNumber().sendKeys(excel_data.get(6));

		rtgsPage.getIfscCode().clear();
		rtgsPage.getIfscCode().sendKeys(excel_data.get(4));
		...
		rtgsPage.getHouse().clear();
		rtgsPage.getHouse().sendKeys(excel_data.get(8));
		rtgsPage.getLocality().clear();
		rtgsPage.getLocality().sendKeys(excel_data.get(9));
		rtgsPage.getPinCode().clear();
		rtgsPage.getPinCode().sendKeys(excel_data.get(10));

		boolean district_bool = wait
				.until(ExpectedConditions.textToBePresentInElementValue(rtgsPage.getDistrict(), excel_data.get(11)));
		String copied_district = null;
		...
		boolean state_bool = wait
				.until(ExpectedConditions.textToBePresentInElement(rtgsPage.getState(), excel_data.get(12)));
		...
		WebElement categoryElement = rtgsPage.selectCategory(categoryChangeTo);
		...
		if (categoryChangeTo == "individual" || categoryChangeTo.equals("individual")) {
			if (proprietorshipChangeTo == "yes" || proprietorshipChangeTo.equals("yes")) {
				...
				Assert.assertEquals(Proprietorship_txt2.getText(), "Write the name of the Proprietorship");
				// type Name of proprietorship
				rtgsPage.getProprietorshipName().clear();
				rtgsPage.getProprietorshipName().sendKeys(name_of_proprietorship);
			} else {
				WebElement proprietorship_no = rtgsPage.getNoProprietorship(categoryElement);
		...
		rtgsPage.get1stPanInput().sendKeys(changePanNoTo[0]);
		rtgsPage.get2ndPanInput().sendKeys(changePanNoTo[1]);
		rtgsPage.get3rdPanInput().sendKeys(changePanNoTo[2]);
		rtgsPage.get4thPanInput().sendKeys(changePanNoTo[3]);
		rtgsPage.get5thPanInput().sendKeys(changePanNoTo[4]);
		rtgsPage.get6thPanInput().sendKeys(changePanNoTo[5]);
		rtgsPage.get7thPanInput().sendKeys(changePanNoTo[6]);
		rtgsPage.get8thPanInput().sendKeys(changePanNoTo[7]);
		rtgsPage.get9thPanInput().sendKeys(changePanNoTo[8]);
		rtgsPage.getLastPanInput().sendKeys(changePanNoTo[9]);
		...
		if (text_for_invalid_pan != "") {
			...
			rtgsPage.getWrongPanRemark().sendKeys("text_for_invalid_pan");
		...
		Assert.assertEquals(amount_converted_in_words, amount_in_words_txt);
		rtgsPage.getNarationInput().clear();
		rtgsPage.getNarationInput().sendKeys(excel_data.get(19));
		...
		rtgsPage.getDonationNature(donationNature).click();
		// Assert.assertTrue(rtgsPage.getDonationNature2(donationNature).isSelected());

		if (donationNature == "Other" || donationNature.equals("Other")) {
			rtgsPage.getOtherNatureOfDonation().clear();
			rtgsPage.getOtherNatureOfDonation().sendKeys(excel_data.get(23));
		}
		...
		if (party_unit == "CountryState") {
			...
			WebElement state_unit = wait
					.until(ExpectedConditions.visibilityOfElementLocated(rtgsPage.selectGivenState(state_unit_name)));
			state_unit.click();
			log.info(state_unit_name + " selected");
			...
			// select mandal
			WebElement selectMandal = wait.until(ExpectedConditions.elementToBeClickable(rtgsPage.getSelectMandal()));
			selectMandal.click();
			log.info("clicked on select mandal");

			WebElement mandal_unit = wait
					.until(ExpectedConditions.visibilityOfElementLocated(rtgsPage.selectGivenMandal(mandal_unit_name)));
			mandal_unit.click();
			log.info(mandal_unit_name + " selected for mandal unit");
		}
		...
		log.info("RTGS Mode Transaction edited successfully");
		// setting reverseText
	...
	@Test(dependsOnMethods = { "editActionForRTGS" })
	public void reversedActionForRTGS() throws InterruptedException, IOException {
		...
		log.info("RTGS Mode Reversed Successfully");
		ngDriver.waitForAngularRequestsToFinish();

	}

	@Test(dependsOnMethods = { "reversedActionForRTGS" })
	public void archiveActionForRTGS() throws InterruptedException, IOException {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(50));
		ngDriver.waitForAngularRequestsToFinish();
		Thread.sleep(5000);
		...
		log.info("RTGS Transaction Archived Successfully");
	}

	@Test(dependsOnMethods = { "archiveActionForRTGS" })
	public void unarchiveActionForRTGS() throws InterruptedException, IOException {

		System.out.println("&&&& unarchiveActionForRTGS section ----");
		Thread.sleep(5000);
		// explicit wait
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(50));
		...
		log.info("RTGS Transaction Unarchive successfully");
	}

	@Test(dependsOnMethods = { "unarchiveActionForRTGS" })

	public void downloadDonationListTestForRTGS() throws InterruptedException, IOException {
		// explicit wait
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(50));
		ngDriver.waitForAngularRequestsToFinish();
		Thread.sleep(5000);
		...
		ArrayList<String> excel_data_for_download_total_form = dd.getData("RTGS", a);
	...
	@Test(dependsOnMethods = { "downloadDonationListTestForRTGS" })

	public void actionRequiredForPanCardRTGS() throws InterruptedException, IOException {
