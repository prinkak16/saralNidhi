...
public class RTGSRelatedTest extends Base {
	...
	public void basePageNavigation(ITestContext context) throws IOException, InterruptedException {
		...
		WebElement heading1 = wait
				.until(ExpectedConditions.visibilityOfElementLocated(rtgsPage.getFirstHeading()));
		...
		// click on RTGS tab
			...
			JavascriptExecutor js = (JavascriptExecutor) driver;
	           ...
	           // clicking on 3 dots for action 
				...
				Boolean b = driver.findElement(By.cssSelector("*[value='2']")).isSelected();
				Boolean ca = driver.findElement(By.xpath("//input[@value='2']")).isSelected();
				
				System.out.println("RTGS is selected :"+b);
				System.out.println("RTGS is selected2 :"+ca);
                ...
                /*
        		boolean district_bool = wait
        				.until(ExpectedConditions.textToBePresentInElementValue(rtgsPage.getDistrict(), "Pune"));
        		String copied_district = null;
