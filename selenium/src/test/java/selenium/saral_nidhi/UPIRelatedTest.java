...
public class UPIRelatedTest extends Base {
	...
	public void basePageNavigation(ITestContext context) throws IOException, InterruptedException {
		...
		//String collector_name_error = upiPage.getWrongCollectorName(collector_name_input).getText();
		...
		wait.until(ExpectedConditions.textToBePresentInElement(upiPage.getWrongCollectorPhone(collecter_phone), "Please enter correct phone number"));
		//String collector_phone_error = upiPage.getWrongCollectorPhone(collecter_phone).getText();
		...
		// click on UPI tab
			...
			JavascriptExecutor js = (JavascriptExecutor) driver;
	           ...
	           // clicking on 3 dots for action 
				...
				Boolean b = driver.findElement(By.cssSelector("*[value='6']")).isSelected();
				Boolean ca = driver.findElement(By.xpath("//input[@value='6']")).isSelected();
				
				System.out.println("upi is selected :"+b);
				System.out.println("upi is selected2 :"+ca);
                ...
                /*
        		boolean district_bool = wait
        				.until(ExpectedConditions.textToBePresentInElementValue(upiPage.getDistrict(), "Pune"));
        		String copied_district = null;
