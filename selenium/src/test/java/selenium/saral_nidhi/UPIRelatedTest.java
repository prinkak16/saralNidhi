...
public class UPIRelatedTest extends Base {
	...
	public void basePageNavigation(ITestContext context) throws IOException, InterruptedException {
        ...
        */
		...
		random_utr_no = "abc" + random_utr_no;
		...
		for (String party_unit : party_unit_arr) {
			...
			if (party_unit == "CountryState") {
				...
				zila_exist = upiPage.isElementPresent(driver, "zila").isDisplayed();
	...
	public void editActionForUPI() throws InterruptedException, IOException {
		...
		Assert.assertTrue(submitText.contains("Record Update successfully"),"Record Update successfully not found in edit");
		// setting reverseText
